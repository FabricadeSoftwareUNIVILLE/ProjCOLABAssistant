...
public interface ConsultAccessoriesRepository extends JpaRepository<AssistiveAccessory, Long>{
	@Query("select NEW br.univille.projcolabassistant.viewmodel.AssistiveAccessoryViewModel(a,photo) from AssistiveAccessory a, IN(a.photoList) photo order by a.category.name, a.id")
